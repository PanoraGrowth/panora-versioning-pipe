...
#   - Read HEAD commit subject. If it matches ANY glob pattern in the
#     hotfix.keyword list (config-driven), scenario is "hotfix".
...
# Base keyword for branch prefix matching in PR context
